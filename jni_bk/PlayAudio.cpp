...
void av_createBufferQueueAudioPlayer(int rate, int channel,int bitsPerSample){
    SLresult result;
...
void av_audioWrite(const void*buffer, int size) {
